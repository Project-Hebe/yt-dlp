/// Base EJS solver implementation
/// Based on youtube_explode_dart's BaseEJSSolver
/// Handles common caching and parsing logic for EJS solvers
library base_ejs_solver;
...
abstract class BaseEJSSolver extends BaseJSChallengeSolver {
  ...
  /// Subclasses must implement this method to execute JS in their specific runtime.
  ...
  Future<Map<String, String?>> solveBulk(
    ...
    // Build JS call using EJSBuilder
